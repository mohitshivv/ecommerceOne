...
<p className="text-sm text-gray-600 dark:text-gray-400 mb-6">Step 1 of 2</p>
    ...
    <form onSubmit={submit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div>
        <label htmlFor="zip" className="block text-sm mb-1">ZIP / PIN</label>
        <input
          id="zip"
          className={`w-full rounded border px-3 py-2 dark:bg-gray-700 ${
      ...
      <div className="md:col-span-2">
        <label htmlFor="address1" className="block text-sm mb-1">Address Line 1</label>
        <input
          id="address1"
          className={`w-full rounded border px-3 py-2 dark:bg-gray-700 ${
      ...
      <div className="md:col-span-2">
        <label htmlFor="address2" className="block text-sm mb-1">Address Line 2 (optional)</label>
        <input
          id="address2"
          className="w-full rounded border px-3 py-2 dark:bg-gray-700 border-gray-300 dark:border-gray-600"
          value={form.address2}
